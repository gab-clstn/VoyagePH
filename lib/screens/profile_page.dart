...
class ProfilePage extends StatelessWidget {
  ...
  Future<void> _openMailClient({required String to, required String subject, String? body}) async {
    final uri = Uri(
      scheme: 'mailto',
      path: to,
      queryParameters: {
  ...
  Future<void> _launchContactUs(BuildContext context) async {
    ...
    final body = 'Hello VoyagePH team,\n\nUser: ${user?.email ?? 'unknown'}\nUID: ${user?.uid ?? 'unknown'}\n\n';
    await _openMailClient(to: 'support@voyageph.example', subject: 'VoyagePH Support', body: body);
    if (context.mounted) {
        ...
        return SafeArea(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text('Philippine Holidays', style: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.bold, color: _primary)),
                        ...
                        onTap: () {
                          ...
                          showDialog(
                            ...
                            builder: (_) => AlertDialog(
                              ...
                              content: Text('Date: ${d.month}/${d.day}/${d.year}\n\n${h['notes'] ?? ''}', style: GoogleFonts.poppins()),
  ...
  List<Map<String, dynamic>> _philippineHolidays(int year) {
    return [
      ...
      {'date': DateTime(year, 3, 8), 'name': "EDSA Revolution Anniversary", 'notes': ''},
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('PROFILE & SETTINGS', style: GoogleFonts.poppins(color: Colors.white, fontWeight: FontWeight.w600)),
      ),
      body: SingleChildScrollView(
        padding: const EdgeInsets.all(20),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text("ACCOUNT", style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.bold)),
          ...
          Container(
            ...
            child: Row(children: [
              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text(displayName.isEmpty ? "User Name" : displayName, style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.bold)),
          ...
          ListTile(
            ...
            subtitle: Text("Manage your account details", style: GoogleFonts.poppins(fontSize: 12)),
            onTap: () {
          ...
          ListTile(
            ...
            subtitle: Text("Send password reset email or change now", style: GoogleFonts.poppins(fontSize: 12)),
            onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => ResetPasswordScreen())),
          ),
          ListTile(
            leading: const Icon(Icons.delete_outline),
            title: Text("Delete Account", style: GoogleFonts.poppins(color: Colors.redAccent)),
            subtitle: Text("Request deletion via email or delete now (requires password)", style: GoogleFonts.poppins(fontSize: 12)),
            onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const DeleteAccountScreen())),
          ),

          const SizedBox(height: 15),
          Text("INFORMATION", style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.bold)),
          ListTile(
            leading: const Icon(Icons.flag_outlined),
          ...
          const SizedBox(height: 15),
          Text("FAQ & RESOURCES", style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.bold)),
          ListTile(
          ...
          ElevatedButton.icon(
            ...
            style: ElevatedButton.styleFrom(backgroundColor: const Color.fromARGB(255, 46, 100, 155), foregroundColor: Colors.white, minimumSize: const Size(double.infinity, 48)),
          ),
        ]),
      ),
    );
...
class SimpleInfoScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(title, style: GoogleFonts.poppins()), backgroundColor: primary),
      body: Padding(
        padding: const EdgeInsets.all(16),
        child: SingleChildScrollView(child: Text(content, style: GoogleFonts.poppins(fontSize: 15))),
      ),
    );
  }
}
...
class ContactUsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Color primary = const Color.fromARGB(255, 11, 66, 121);
    return Scaffold(
      appBar: AppBar(title: Text('Contact Us', style: GoogleFonts.poppins()), backgroundColor: primary),
      body: Padding(
        padding: const EdgeInsets.all(16),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text('Support Email', style: GoogleFonts.poppins(fontWeight: FontWeight.w600)),
          const SizedBox(height: 8),
          SelectableText('support@voyageph.example', style: GoogleFonts.poppins(fontSize: 14)),
          const SizedBox(height: 16),
          Text('You can also send us a message using your mail app.', style: GoogleFonts.poppins()),
...
class _ResetPasswordScreenState extends State<ResetPasswordScreen> {
  ...
  Future<void> _sendReset() async {
    ...
    try {
      ...
      setState(() => _message = 'Password reset email sent. Check your inbox or Gmail.');
  ...
  Widget build(BuildContext context) {
    final Color primary = const Color.fromARGB(255, 11, 66, 121);
    return Scaffold(
      appBar: AppBar(title: Text('Reset Password', style: GoogleFonts.poppins()), backgroundColor: primary),
      body: Padding(
        padding: const EdgeInsets.all(16),
        child: Column(children: [
          Text('Send a password reset email. Open your mail client to confirm.', style: GoogleFonts.poppins()),
          const SizedBox(height: 12),
          TextField(controller: _emailCtrl, decoration: InputDecoration(labelText: 'Email', border: const OutlineInputBorder()), keyboardType: TextInputType.emailAddress),
          const SizedBox(height: 12),
...
class _DeleteAccountScreenState extends State<DeleteAccountScreen> {
  ...
  Widget build(BuildContext context) {
    final Color primary = const Color.fromARGB(255, 11, 66, 121);
    return Scaffold(
      appBar: AppBar(title: Text('Delete Account', style: GoogleFonts.poppins()), backgroundColor: primary),
      body: Padding(
        padding: const EdgeInsets.all(16),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      // Update display name
      final displayName = '${_firstCtrl.text.trim()} ${_lastCtrl.text.trim()}'.trim();
      ...
      if (newEmail.isNotEmpty && newEmail != user.email) {
        ...
        if (current == null) throw Exception('User not available after reauthentication');
    ...
    return showDialog<String?>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(onPressed: () => Navigator.of(ctx).pop(ctrl.text), child: Text('Confirm', style: GoogleFonts.poppins())),
        ],
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    final Color primary = const Color.fromARGB(255, 11, 66, 121);
    return Scaffold(
      appBar: AppBar(title: Text('Edit Profile', style: GoogleFonts.poppins()), backgroundColor: primary),
      body: Padding(
        ...
        child: Column(children: [
          Form(
            key: _formKey,
            child: Column(children: [
              TextFormField(controller: _firstCtrl, decoration: const InputDecoration(labelText: 'First name'), validator: (v) => v == null || v.trim().isEmpty ? 'Enter first name' : null),
              const SizedBox(height: 12),
              TextFormField(controller: _lastCtrl, decoration: const InputDecoration(labelText: 'Last name'), validator: (v) => v == null || v.trim().isEmpty ? 'Enter last name' : null),
              const SizedBox(height: 12),
              TextFormField(controller: _emailCtrl, decoration: const InputDecoration(labelText: 'Email'), keyboardType: TextInputType.emailAddress, validator: (v) => v == null || !v.contains('@') ? 'Enter valid email' : null),
            ]),
          ),
          const SizedBox(height: 16),
...
class InAppEmailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Color primary = const Color.fromARGB(255, 11, 66, 121);
    return Scaffold(
      appBar: AppBar(title: Text('Message — VoyagePH', style: GoogleFonts.poppins()), backgroundColor: primary),
      body: Padding(
        padding: const EdgeInsets.all(16),
        child: Column(children: [
          // message header
          Row(children: [
            CircleAvatar(backgroundColor: primary, child: Text('V', style: GoogleFonts.poppins(color: Colors.white))),
            const SizedBox(width: 12),
            Expanded(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(subject, style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w600)),
                const SizedBox(height: 4),
                Text('From: $from', style: GoogleFonts.poppins(fontSize: 12, color: Colors.black87)),
                Text('To: ${to.isEmpty ? "(not specified)" : to}', style: GoogleFonts.poppins(fontSize: 12, color: Colors.black54)),
              ]),
            ),
          ]),
          const SizedBox(height: 12),
            ...
            child: Card(
              ...
              child: Padding(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                  Expanded(child: SingleChildScrollView(child: Text(body, style: GoogleFonts.poppins(fontSize: 14, height: 1.5)))),
                  const SizedBox(height: 12),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text('Reset your password', style: GoogleFonts.poppins(fontSize: 16, color: Colors.white)),
                    ),
                  ),
                  const SizedBox(height: 8),
                  Text('If you did not request this, ignore this message.', style: GoogleFonts.poppins(fontSize: 12, color: Colors.black54)),
                ]),
              ),
            ),
          ),
